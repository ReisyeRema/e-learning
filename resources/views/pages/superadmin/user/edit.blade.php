                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('users.update', $user->id) }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="name" class="form-control @error('name') is-invalid @enderror"
                                                value="{{ old('name', $user->name) }}" type="text" id="exampleInputName1"
                                                placeholder="Name">
                                            @error('name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="username" class="form-control @error('username') is-invalid @enderror"
                                                value="{{ old('username', $user->username) }}" type="text" id="exampleInputusername1"
