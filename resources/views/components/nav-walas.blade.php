...
<div class="container">
    <div class="d-flex justify-content-center gap-3 my-4">
        <a href="{{ route('daftar-siswa.index', ['kelas' => $kelasSlug, 'tahunAjaran' => $tahunAjaranSlug]) }}"
            class="btn btn-sm btn-custom {{ request()->is('*daftar-siswa/*') ? 'btn-primary' : 'btn-outline-primary' }} mr-3">
            Daftar Siswa
        </a>
        <a href="{{ route('daftar-mapel.index', ['kelas' => $kelasSlug, 'tahunAjaran' => $tahunAjaranSlug]) }}"
            class="btn btn-sm btn-custom {{ request()->is('*daftar-mapel/*') ? 'btn-primary' : 'btn-outline-primary' }} mr-3">
            Daftar Mata Pelajaran
        </a>
        <a href="{{ route('export-nilai.index', ['kelas' => $kelasSlug, 'tahunAjaran' => $tahunAjaranSlug]) }}"
            class="btn btn-sm btn-custom {{ request()->is('*export-nilai/*') ? 'btn-primary' : 'btn-outline-primary' }} mr-3">
            Export Nilai
        </a>
