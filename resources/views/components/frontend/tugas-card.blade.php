        ...
        <div class="card shadow-sm border-20 rounded p-3 hover-effect position-relative">
            ...
            <div class="row g-1 align-items-center">
                ...
                <div class="col-md-2 text-center">
                    <img src="{{ asset('assets/img/tugas.png') }}" class="img-fluid rounded" alt="Gambar tugas"
                ...
                <div class="col-md-10">
                    ...
                    <div class="text-end mt-2">
                        @if ($submitTugas && ($submitTugas->url || $submitTugas->file_path))
                            <a href="#" class="text-decoration-none fw-bold" data-bs-toggle="modal"
                                data-bs-target="#modalDetailTugas{{ $tugas->id }}">Lihat</a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <div>:
                                <span
                                    class="badge {{ $submitTugas->skor !== null ? 'bg-success' : 'bg-secondary' }} fs-8">
