                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo e(route('pembelajaran.update', $pembelajaran->id)); ?>" method="POST" class="forms-sample"
...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e(old('nama_mapel', $pembelajaran->nama_mapel)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <?php $__currentLoopData = $guru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id); ?>"
                                                        <?php echo e(old('guru_id', $pembelajaran->guru_id) == $item->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <?php $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id); ?>"
                                                        <?php echo e(old('kelas_id', $pembelajaran->kelas_id) == $item->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <?php $__currentLoopData = $tahunAjaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id); ?>"
                                                        <?php echo e(old('tahun_ajaran_id', $pembelajaran->tahun_ajaran_id) == $item->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <?php $__currentLoopData = $kurikulum; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id); ?>"
                                                        <?php echo e(old('kurikulum_id', $pembelajaran->kurikulum_id) == $item->id ? 'selected' : ''); ?>>
                                                        <?php echo e($item->nama_kurikulum); ?>

                                                    </option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                            <?php $__errorArgs = ['kurikulum_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if($pembelajaran->cover): ?>
                                                <p class="mt-2">Cover saat ini: <a href="<?php echo e(asset('storage/covers/' . $pembelajaran->cover)); ?>" target="_blank">Lihat Cover</a></p>
                                            <?php endif; ?>
                                        </div>                                        

                                        <div class="form-group d-flex justify-content-end">
                                            <button type="submit" class="btn btn-primary mr-2">Submit</button>
                                            <a href="<?php echo e(route('pembelajaran.index')); ?>" class="btn btn-light">Cancel</a>
                                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DATA MATKUL\SEMESTER 6\TA\PROJECT\e-learn-laravel\resources\views/pages/admin/pembelajaran/edit.blade.php ENDPATH**/ ?>