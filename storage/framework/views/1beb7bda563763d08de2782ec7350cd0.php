...
<head>
  ...
  <title>Not Found | Learning Management System</title>
          ...
          <div class="col-lg-7 mx-auto text-white">
            ...
            <div class="row mt-5">
              <div class="col-12 text-center mt-xl-2">
                <a class="text-white font-weight-medium" href="<?php echo e(route('dashboard')); ?>">Kembali Ke Dashboard</a>
              </div>
            </div>
            <div class="row mt-5">
...
<?php /**PATH D:\DATA MATKUL\SEMESTER 6\TA\PROJECT\e-learn-laravel\resources\views/errors/404.blade.php ENDPATH**/ ?>