                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo e(route('pembelajaran.store')); ?>" method="POST" class="forms-sample"
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <?php $__currentLoopData = $kurikulum; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id); ?>"
                                                        <?php echo e(old('kurikulum_id') == $item->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e(old('semester')); ?>" id="exampleSelectGender">
                                                <option value="">Pilih Semester</option>
                                                <option value="Ganjil"
                                                    <?php echo e(old('semester') == 'Ganjil' ? 'selected' : ''); ?>>
                                                    Ganjil</option>
                                                <option value="Genap"
                                                    <?php echo e(old('semester') == 'Genap' ? 'selected' : ''); ?>>
                                                    Genap</option>
                                            </select>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DATA MATKUL\SEMESTER 6\TA\PROJECT\e-learn-laravel\resources\views/pages/admin/pembelajaran/create.blade.php ENDPATH**/ ?>