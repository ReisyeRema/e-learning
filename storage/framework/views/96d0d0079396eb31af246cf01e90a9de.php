    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" method="post" action="<?php echo e(route('password.update')); ?>">
...
<?php /**PATH D:\DATA MATKUL\SEMESTER 6\TA\PROJECT\e-learn-laravel\resources\views/profile/partials/update-password-form.blade.php ENDPATH**/ ?>