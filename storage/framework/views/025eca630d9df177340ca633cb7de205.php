                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo e(route('siswa.store')); ?>" method="POST" class="forms-sample"
...
unset($__errorArgs, $__bag); ?>"
                                                        value="<?php echo e(old('nis')); ?>" type="text" id="exampleInputnis1"
                                                        placeholder="nis">
                                                    <?php $__errorArgs = ['nis'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group d-flex justify-content-end">
                                            ...
                                            <a href="<?php echo e(route('siswa.index')); ?>" class="btn btn-light">Cancel</a>
                                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DATA MATKUL\SEMESTER 6\TA\PROJECT\e-learn-laravel\resources\views/pages/admin/siswa/create.blade.php ENDPATH**/ ?>