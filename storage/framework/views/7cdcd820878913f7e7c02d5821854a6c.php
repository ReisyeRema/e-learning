...
unset($__errorArgs, $__bag); ?>"
                                                        value="<?php echo e(old('username', $siswa->user->username)); ?>" type="text"
...
unset($__errorArgs, $__bag); ?>"
                                                        value="<?php echo e(old('name', $siswa->user->name)); ?>" type="text"
...
unset($__errorArgs, $__bag); ?>"
                                                        value="<?php echo e(old('nis', $siswa->nis)); ?>" type="text"
...
unset($__errorArgs, $__bag); ?>"
                                                        value="<?php echo e(old('email', $siswa->user->email)); ?>" type="email"
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        <option value="Laki-Laki"
                                                            <?php echo e(old('jenis_kelamin', $siswa->jenis_kelamin) == 'Laki-Laki' ? 'selected' : ''); ?>>
                                                            Laki-Laki
                                                        </option>
                                                        <option value="Perempuan"
                                                            <?php echo e(old('jenis_kelamin', $siswa->jenis_kelamin) == 'Perempuan' ? 'selected' : ''); ?>>
                                                            Perempuan
                                                        </option>
                                                    </select>
...
unset($__errorArgs, $__bag); ?>"
                                                        value="<?php echo e(old('alamat', $siswa->alamat)); ?>" type="text"
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        <?php $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($item->id); ?>"
                                                                <?php echo e(old('kelas_id', $siswa->kelas_id) == $item->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DATA MATKUL\SEMESTER 6\TA\PROJECT\e-learn-laravel\resources\views/pages/admin/siswa/edit.blade.php ENDPATH**/ ?>