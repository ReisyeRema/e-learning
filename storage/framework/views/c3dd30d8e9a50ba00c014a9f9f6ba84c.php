                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo e(route('guru.store')); ?>" method="POST" class="forms-sample"
...
unset($__errorArgs, $__bag); ?>"
                                                        value="<?php echo e(old('name')); ?>" type="text" id="exampleInputName1"
                                                        placeholder="Name">
...
unset($__errorArgs, $__bag); ?>"
                                                        value="<?php echo e(old('nip')); ?>" type="text" id="exampleInputnip1"
                                                        placeholder="Nip">
                                                    <?php $__errorArgs = ['nip'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>"
                                                        value="<?php echo e(old('email')); ?>" type="email" id="exampleInputEmail3"
                                                        placeholder="Email">
...
unset($__errorArgs, $__bag); ?>"
                                                        value="<?php echo e(old('tempat_lahir')); ?>" type="text"
...
unset($__errorArgs, $__bag); ?>"
                                                            value="<?php echo e(old('tanggal_lahir')); ?>" type="text"
...
unset($__errorArgs, $__bag); ?>"
                                                        value="<?php echo e(old('jenis_kelamin')); ?>" id="exampleSelectGender">
                                                        <option value="">Pilih Jenis Kelamin</option>
                                                        <option value="Laki-Laki"
                                                            <?php echo e(old('jenis_kelamin') == 'Laki-Laki' ? 'selected' : ''); ?>>
                                                            Laki-Laki</option>
...
unset($__errorArgs, $__bag); ?>"
                                                        value="<?php echo e(old('alamat')); ?>" type="text"
...
unset($__errorArgs, $__bag); ?>"
                                                        value="<?php echo e(old('status')); ?>" id="exampleSelectGender">
                                                        <option value="">Pilih Status</option>
                                                        <option value="PNS"
                                                            <?php echo e(old('status') == 'PNS' ? 'selected' : ''); ?>>PNS</option>
                                                        <option value="Honorer"
                                                            <?php echo e(old('status') == 'Honorer' ? 'selected' : ''); ?>>Honorer
                                                        </option>
                                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group d-flex justify-content-end">
                                            ...
                                            <a href="<?php echo e(route('guru.index')); ?>" class="btn btn-light">Cancel</a>
                                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DATA MATKUL\SEMESTER 6\TA\PROJECT\e-learn-laravel\resources\views/pages/admin/guru/create.blade.php ENDPATH**/ ?>