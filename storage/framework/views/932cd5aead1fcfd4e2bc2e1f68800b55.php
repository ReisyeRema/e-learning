                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($item->file_path): ?>
                                                        <div class="mt-2">
                                                            <a href="https://drive.google.com/file/d/<?php echo e($item->file_path); ?>/view"
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <form id="deleteForm<?php echo e($item->id); ?>" action="<?php echo e(route('tugas.destroy', $item->id)); ?>" method="POST" style="display: none;">
                                                            <?php echo csrf_field(); ?>
                                            ...
                                            <div class="modal fade" id="editKelasModal<?php echo e($item->id); ?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="<?php echo e(route('tugas.update', $item->id)); ?>"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="materi_id"
                                                                        class="form-control <?php $__errorArgs = ['materi_id'];
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DATA MATKUL\SEMESTER 6\TA\PROJECT\e-learn-laravel\resources\views/pages/admin/tugas/index.blade.php ENDPATH**/ ?>