...
<?php if(auth()->guard()->check()): ?>
    <aside id="profile-sidebar" class="profile-sidebar">
        ...
        <ul class="profile-menu">
            ...
            <li>
                <a href="<?php echo e(route('list-tugas.index')); ?>" class="<?php echo e(Request::routeIs('list-tugas.index') ? 'active' : ''); ?>">
                    <i class="fas fa-tasks"></i> Tugas
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('list-kuis.index')); ?>" class="<?php echo e(Request::routeIs('list-kuis.index') ? 'active' : ''); ?>">
