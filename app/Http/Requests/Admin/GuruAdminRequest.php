...
class GuruAdminRequest extends FormRequest
{
    ...
    {
        $guru = $this->route('guru'); // Ambil parameter guru dari route (null jika tidak ada)
        $guruId = $guru ? $guru->id : null; // Jika null, set ke null
        ...
        return [
            ...
            // Validasi untuk guru
            'nip' => 'nullable|string|unique:guru,nip,' . $guruId,
    ...
    public function messages(): array
    {
        return [
            ...
            'status.in' => 'Status harus salah satu dari: PNS, Honorer.',
        ];
    }
}
